	...
	if($gcid){
		...
		if ($result->num_rows > 0) {
			...
			if($wzzpdjpd==""){
				...
				//保存违章条目
				$sqli1 = "insert into 处罚条目 (内容,危险源id,工程id,工程名称,通知单编号,录入时间,时间戳) values ('$okwetm','$wxyid','$gcid','$gcmc','$tzdbh','$timestr','$sjc')";
				
				$sqli2 = "insert into 图片附件 (工程id,危险源id,工程名称,通知单编号,时间戳) values ('$gcid','$wxyid','$gcmc','$tzdbh','$sjc')";
