<?php
	...
	if($gcid){
		...
		if ($result->num_rows > 0) {
			...
			if($wzzpdjpd==""){
				$sqli = "insert into 通知单 (工程id,工程名称,检查层级,时间戳, 巡查类别,通知单编号,检查单位, 检查对象,检查类型,违章大类,检查日期,违章状态,草稿新建人电话,整改期限,草稿新建日期,通知单状态,地区省,地区市,项目经理,生产经理,安全总监,安全员,工长,责任人,检查内容) values ('$gcid','$gcmc','$jccj','$sjc','$xclb','$tzdbh','$jcdw','$jcdx','$jcxm_jc','$wzdl','$jcrq','$wzzt','$zzsjh','$czgqx','$timestr','草稿','$sheng','$shi','$xmjl','$scjl','$aqzj','$aqy','$gz','$zrr','$jcnrConnection')";
