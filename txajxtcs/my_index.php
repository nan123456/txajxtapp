<?php
	...
	if($zgscount ==0&&$fgs==null){
			$mysql2 = "SELECT 时间戳,工程名称 from `我的工程` where 时间戳 in(SELECT 工程时间戳 FROM `工程管理人员` WHERE 部门='项目部' AND 联系方式='".$mobile."' ) OR (项目经理手机='".$mobile."' OR 安全主管手机='".$mobile."' OR `安全员手机`='".$mobile."'OR 生产经理手机='".$mobile."' OR 机械管理员手机='".$mobile."'OR 质量员手机='".$mobile."' ) ORDER  BY  时间戳 DESC LIMIT 1";
	...
	if($mode=="wdgc"){
		...
		if ($mobile=="13603070333"||$mobile=="13826467128"||$mobile=="13632665565"||$mobile=="13510881338"){
			...
			if($zgscount!=0){
				...
				$sql1 = "select * from 我的工程  where 形象进度!='竣工验收' and 工程名称 = '$xmb' ";
			}
		}
		...
		if ($mobile=="13603070333"||$mobile=="13826467128"||$mobile=="13632665565"||$mobile=="13510881338"){
			...
			$sqldate='';
			$sql1 = "select * from 我的工程 where 总公司负责人A手机='".$mobile."' or 总公司负责人B手机='".$mobile."' or 总公司负责人C手机='".$mobile."' or 总部巡查员手机='".$mobile."' or 项目经理手机='".$mobile."' or 安全主管手机='".$mobile."' or 安全员手机='".$mobile."' or 机械管理员手机='".$mobile."' or 联系方式='".$mobile."' or 部门负责人A手机='".$mobile."' or 部门负责人B手机='".$mobile."' or 部门负责人C手机='".$mobile."' or 生产经理手机='".$mobile."' or 质量员手机='".$mobile."'";
			$result1 = $conn->query($sql1);
			$class = mysqli_num_rows($result1); 
			if ($result1->num_rows > 0) {
				$sql = "select a.id,a.工程名称,b.通知单状态,b.通知单编号,b.整改期限 from 我的工程 a,通知单 b where b.通知单状态 in ('延期','整改中') and a.工程名称=b.工程名称 and (a.总公司负责人A手机='".$mobile."' or a.总公司负责人B手机='".$mobile."' or a.总公司负责人C手机='".$mobile."' or a.总部巡查员手机='".$mobile."' or a.项目经理手机='".$mobile."' or a.安全主管手机='".$mobile."' or a.安全员手机='".$mobile."' or a.机械管理员手机='".$mobile."' or a.联系方式='".$mobile."' or a.部门负责人A手机='".$mobile."' or a.部门负责人B手机='".$mobile."' or a.部门负责人C手机='".$mobile."' or a.生产经理手机='".$mobile."' or a.质量员手机='".$mobile."') order by a.工程名称,b.通知单状态 desc";
				$result = $conn->query($sql);
				$class = mysqli_num_rows($result); 
				if ($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
