    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="">同欣</a>
        </div>
	...
	<div class="panel-heading">
		...
		//										echo $_GET["id"];
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="nr" name="nr" value="<?php echo $row["内容"];?>" placeholder="同欣">
						</div>
						<label for="dx" class="col-sm-2 control-label">对象：</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" id="dx" name="dx" value="<?php echo $row["对象"];?>" placeholder="同欣">
						</div>
					</div>
					<div class="form-group">
