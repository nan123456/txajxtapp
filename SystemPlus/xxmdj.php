    			...
    			<div class="bs-docs-sidebar affix" role="complementary">
    				<ul class="nav bs-docs-sidenav">
    					<li class="active">
    						<a>数据维护</a>
    						<ul class="nav">
    							<li  class="active"><a href="">工程信息维护</a></li>
...
<!--								<form id="xmdjform" action="bc1.php" method="post" enctype="multipart/form-data" class="form-horizontal cmxform" role="form">-->
				          ...
				          <div class="panel-heading">
									...
									<div class="form-group">
										...
										<label for="aqzg" class="col-sm-2 control-label">安全主管：</label>
										<div class="col-sm-3">
											<input type="text" class="form-control" id="aqzg" name="aqzg" placeholder="安全主管">
										</div>
									</div>
									<div class="form-group">
