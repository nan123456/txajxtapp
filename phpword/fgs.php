...
//标题
	$section->addText('同欣隐患整改通知单', array('size'=>20, 'bold'=>true),$styleCell);
...
//  表格
	...
	$table -> addCell(800, array('cellMerge'=>'continue', 'valign'=>'center'))->addtext('',array('bold'=>false),$styleCell);
	$table -> addCell(3300, array('cellMerge'=>'restart', 'valign'=>'center'))->addtext('同欣'.$Jcdw,array('bold'=>false),$styleCell);
...
//		   echo $NLone[0];
	...
	$table -> addCell(2500, array('cellMerge'=>'restart','rowMerge'=>'restart','valign'=>'center'))->addtext($Jcnr,array('bold'=>false),$styleCell);
    ...
    require("../conn.php");
		   ...
		   $hello2=explode("||",$row["内容"]);
			...
			for($index=0;$index<count($hello)-1;$index++) 
			{
   			    ...
   			    $cell_8->addImage("../sgajxtcs/upload/".$hello[$index],array("width"=>275,"height"=>265,"align"=>left));			    
   			    $table->addcell(9250);
   			    $cell_10=$table->addcell(275);
   			    $cell_10->addImage("../sgajxtcs/upload/".$hello1[$index],array("width"=>275,"height"=>265,"align"=>right));
