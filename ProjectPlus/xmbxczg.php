      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <?php
   					...
   					?>
          <a class="navbar-brand" href="../xmbindex.php?yhzh=<?php echo $row["账号"];?>">同欣</a>
        </div>
    			...
    			<div class="bs-docs-sidebar affix" role="complementary">
    				<ul class="nav bs-docs-sidenav">		
    					<li>
    						...
    						<ul class="nav">
    							<li class="active"><a href="xmbxczg.php?id=<?php echo $row["id"];?>&yhid=<?php echo $yhid;?>">巡查整改</a></li>
    							<li class=""><a href="xmbzlsc.php?id=<?php echo $row["id"];?>&yhid=<?php echo $yhid;?>">质量实测</a></li>
    						</ul>
    					</li>    									
    				</ul>
    			</div>    			
...
<div id="xmbj" class="panel panel-info ">
  ...
  <!--<div class="btn-group">
    					...
    					<button class="btn btn-default" onclick="save4()">隐患整改记录报表打印</button>
    					<table id="">
