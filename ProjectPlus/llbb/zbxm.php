...
<div class="row"  style="text-align:center;padding-bottom: 75px;" >
	<div class="col-xs-6 col-md-6" style="text-align:right;position: relative;">		
		<img src="../../txajxtcs/upload/<?php echo $hello[$index];?>"  alt="草稿<?php echo $index;?>" style="width:255px;height:246.5px;"/>
	...
	<div class="col-xs-6 col-md-6" style="text-align:left;position: relative;">
		<img src="../../txajxtcs/upload/<?php echo $hello1[$index];?>" alt="回复<?php echo $index;?>" style="width:255px;height:246.5px;"/> 
