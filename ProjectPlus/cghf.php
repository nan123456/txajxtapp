			...
			<div class="panel-body">
					...
					<form class="form-horizontal" role="form"  id="cghfform" name="cghfform" action="cghfbc.php" method="post">
						<div id="imgCreat" class="col-md-4 col-md-offset-1">
							<img class="img-responsive imgClass" src="" alt="Cinque Terre">
						</div> 
						<input type="text"  id="cgmc" name="cgmc" class="form-control hidden" value=""/>
						<div class="col-md-4 col-md-offset-2" ><textarea id="cghf" cols="35" rows="8"> </textarea></div> 
						...
						<button id="tijiao" type="button" class="btn btn-primary col-sm-offset-9" onclick="window.history.go(-2);">返回</button>
