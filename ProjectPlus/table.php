...
<div id="gclb" class="panel panel-info">
	...
	<div class="panel-body">
		...
		<div id="toolbar" class="btn-group">
			...
			<a class='btn btn-default' href="ProjectPlus/xxmdj.php?<?php $yhid=$_GET["yhid"]; echo $yhid;?>"><i class="glyphicon glyphicon-plus"> 项目登记</i></a>	
...
//				   $sql = "select * from 我的工程  ";
                   ...
                   <td><a href="ProjectPlus/Project_in.php?id=<?php echo $row["id"];?>&<?php $yhid=$_GET["yhid"]; echo $yhid;?>"><?php echo $row["工程名称"];?></a></td>
                   <td><?php echo $row["项目类别"];?></td>
                   <td><?php echo $row["形象进度"];?></td>
                   <td>
                   	 <!--<button id="<?php echo $row["id"];?>" onclick="dianji(this.id);" type="button" class="btn btn-default">删除
                   	 </button>-->
                   	 <input id="<?php echo $row["id"];?>"type="button" onclick="disp_confirm(this.id)" value="删除" />
                   </td>
