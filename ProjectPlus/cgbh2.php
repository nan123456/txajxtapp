...
<div id="xmbj" class="panel panel-info ">
	...
	<div class="panel-heading">
		<h3 class="panel-title">巡查整改-<?php echo $row["通知单状态"];?>-<?php echo $row["工程名称"];?></h3>
	</div>
		...
		<div class="tab-content">
					...
					<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="jccj" name="jccj" value="<?php echo $row["检查层级"];?>" placeholder="同欣">
								</div>
								<label for="xclb" class="col-sm-2 control-label">巡查类别：</label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="xclb" name="xclb" value="<?php echo $row["巡查类别"];?>" placeholder="同欣">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<h2><span class="label label-info col-sm-3 col-sm-offset-1">隐患图片</span></h2>
								<h2><span class="label label-info col-sm-3 col-sm-offset-2">回复图片</span></h2>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3" id="imgCreatHf">
									
								</div>
								
							</div>
							
							<input type="submit" class="btn btn-primary col-sm-offset-9" onclick="self.location=document.referrer;" name="submit" value="返回">
   ...
   <script type="text/javascript" src="../js/jquery.validate.min.js"></script>
    ...
    <script type="text/javascript">
	    $('table').bootstrapTable({		
	  	...
	  	function GetQueryString(name){
			...
			// 调用方法
			tzdbh=GetQueryString("gcid"); //通知单编号_上级页面变量名写错了
			...
			var creatImg=function(tpmc,wztm,i){
				...
				a.href='cghf.php?tpmc='+mysrc+'&cgmc='+tpmc+'&num='+num+'&sjc='+tzdSjc+'&wztm='+wztm_B;	
				imgCreat.appendChild(a);
	...
	//	      	alert('ajax错误'+type+'---'+errorThrown);
	    ...
	    //动态创建回复图片函数
		var creatHfImg=function(tpmc,pfzt,i){
			var pfzt=pfzt; 
			var tpmc=tpmc;				
			var num=i;
			var flag="hf";
			...
			//创建图片附件
			//var sjc=document.getElementById("sjc").value; //通知单时间戳		
			var imgCreatHf=document.getElementById("imgCreatHf");
			var a=document.createElement("a");
			a.href='cgck.php?tpmc='+mysrc+'&cgmc='+tpmc+'&num='+num+'&sjc='+tzdSjc+'&wztm='+wztm_B;	
			imgCreatHf.appendChild(a);
			var img=document.createElement('img');
			img.id="fw"+num;
			//img.style="width:150px;height:150px;";
			img.className="img-responsive img-rounded col-sm-offset-4 imgClass";
			img.src=mysrc;
			a.appendChild(img);
			//与下一级划分
			var div=document.createElement("div");
