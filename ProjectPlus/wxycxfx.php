    			...
    			<div class="bs-docs-sidebar affix" role="complementary">
    				<ul class="nav bs-docs-sidenav">
    					...
    					<li>
    						...
    						<ul class="nav">
									<li  class="active" ><a href="wxycxfx.php?id=<?php echo $row["id"];?>&yhid=<?php echo $yhid ;?>">危险源</a></li>
         	...
         	?>
               ...
               <form class="form-horizontal" method="post">
                 ...
                 <?php
							...
							$Query = "Select count(*) as AllNum from 危险源 where 危险源类型='土方开挖工程' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
///							echo $Query;
							$a     = mysqli_query( $conn, $Query ); 
							$b     = mysqli_fetch_assoc( $a ); 
//							echo $b['AllNum']; //条数  	
							$Query1 = "Select count(*) as AllNum1 from 危险源 where 危险源类型='其他危险性较大的工程' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
							$a1     = mysqli_query( $conn, $Query1 ); 
							$b1     = mysqli_fetch_assoc( $a1 );
							$Query2 = "Select count(*) as AllNum2 from 危险源 where 危险源类型='拆除爆破工程' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
							$a2     = mysqli_query( $conn, $Query2 ); 
							$b2     = mysqli_fetch_assoc( $a2 );
							$Query3 = "Select count(*) as AllNum3 from 危险源 where 危险源类型='起重吊装及安装拆卸工程' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
							$a3     = mysqli_query( $conn, $Query3 ); 
							$b3     = mysqli_fetch_assoc( $a3 );
							$Query4 = "Select count(*) as AllNum4 from 危险源 where 危险源类型='脚手架工程' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
							$a4     = mysqli_query( $conn, $Query4 ); 
							$b4     = mysqli_fetch_assoc( $a4 );
							$Query5 = "Select count(*) as AllNum5 from 危险源 where 危险源类型='模板工程支撑体系' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
							$a5     = mysqli_query( $conn, $Query5 ); 
							$b5     = mysqli_fetch_assoc( $a5 );
							$Query6 = "Select count(*) as AllNum6 from 危险源 where 危险源类型='基坑支护及降水工程' and 工程id='$gcid' and 登记日期 between '$liu'and '$endtime'"; 
             ...
             ?>
    			...
    			<div class="row">
	    			...
	    			<table class="table  table-bordered">
							...
							<tr>
							  <td><a href="#" data-toggle="modal" data-target="#myModal6">基抗支护及降水工程</td></a>
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where 工程id='$gcid' and 危险源类型='其他危险性较大的工程'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where  工程id='$gcid' and 危险源类型='拆除爆破工程'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where 工程id='$gcid' and  危险源类型='起重吊装及安装拆卸工程'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where 工程id='$gcid' and  危险源类型='脚手架工程'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where 工程id='$gcid' and 危险源类型='模板工程支撑体系'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where  工程id='$gcid' and 危险源类型='土方开挖工程'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
								...
								<div class="modal-content">
								   ...
								   <tbody>
								      <?php
                   						require("../conn.php");
															$gcid=$_GET["id"];
                   						$sql = "select * from 危险源   where 工程id='$gcid' and 危险源类型='基坑支护及降水工程'";
                   						$result = $conn->query($sql);
                   						while($row = $result->fetch_assoc()) {
