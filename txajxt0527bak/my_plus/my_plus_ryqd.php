<?php
	...
	$timestr1=$time['year']."-".$time['mon']."-".$time['mday'];
					...
					//if ($mobile==$phone) {
						...
						if ($resultWfg->num_rows > 0) {
							...
							if ($result->num_rows > 0) {
								...
								$sqli = "insert into 人员签到 (工程id,工程名称,人员,签到时间,经纬度,联系方式,记录插入时间,时间戳,部门) values ('$gcid','$gcmc','$name','$timestr1','$jingweidu','$phone','$timestr','$sjc','$bumen')";
