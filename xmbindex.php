...
//					alert (bmaa);
		    	...
		    	$(".col-md-10").load("projectPlus/xmbtable.php?yhid="+yhid+"&gsjb="+'全部');
		    	});
		    	}
		    	else {
		    		$(document).ready(function() {
			    	$("footer").load("footer.html");
			    	$(".col-md-10").load("projectPlus/xmbtable.php?yhid="+yhid+"&gsjb="+bmaa);
			    	});
		    	}
//      var gsjb='全部';
			function show(obj){
...
//					window.location.reload();
					$(document).ready(function() {
		    	$("footer").load("footer.html");
		    	$(".col-md-10").load("projectPlus/xmbtable.php?yhid="+yhid+"&gsjb="+gsjb);
		    	});
			};
