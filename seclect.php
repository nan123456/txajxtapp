    		...
    		<div class="col-md-2">
    			<div class="bs-docs-sidebar affix" role="complementary">
    				<ul class="nav bs-docs-sidenav">
    					...
    					<ul class="nav">
    						<li  class="active"><a href="seclect.php?yhid=<?php echo $yhid=$_GET["yhid"]; ?>">巡查整改查询</a></li>
...
//							$Query = "Select count(*) as AllNum from 通知单 where 通知单状态='草稿' and 检查日期 between 'left(".$liu.",10)' and 'left(".$endtime.",10)'"; 
							$Query = "Select count(*) as AllNum from 通知单 where 通知单状态='草稿' and 地区省='$province6' and 地区市='$city6' and 检查日期 between '$liu'and '$endtime'"; 
///							echo $Query;
							$a     = mysqli_query( $conn, $Query ); 
							$b     = mysqli_fetch_assoc( $a ); 
//							echo $b['AllNum']; //条数  	
							$Query1 = "Select count(*) as AllNum1 from 通知单 where 通知单状态='整改中'  and 地区省='$province6' and 地区市='$city6' and 检查日期 between '$liu'and '$endtime' and cast(整改期限  as datetime) > '$showtime'"; 
							$a1     = mysqli_query( $conn, $Query1 ); 
							$b1     = mysqli_fetch_assoc( $a1 );
							$Query2 = "Select count(*) as AllNum2 from 通知单 where 通知单状态='延期' and 地区省='$province6' and 地区市='$city6' and 检查日期 between '$liu'and '$endtime'"; 
							$a2     = mysqli_query( $conn, $Query2 ); 
							$b2     = mysqli_fetch_assoc( $a2 );
							$Query3 = "Select count(*) as AllNum3 from 通知单 where 通知单状态='整改中' and 地区省='$province6' and 地区市='$city6' and 检查日期 between '$liu'and '$endtime' and cast(整改期限  as datetime) < '$showtime'"; 
							$a3     = mysqli_query( $conn, $Query3 ); 
							$b3     = mysqli_fetch_assoc( $a3 );
							$Query4 = "Select count(*) as AllNum4 from 通知单 where 通知单状态='未完成' and 地区省='$province6' and 地区市='$city6' and 检查日期 between '$liu'and '$endtime'"; 
							$a4     = mysqli_query( $conn, $Query4 ); 
							$b4     = mysqli_fetch_assoc( $a4 );
							$Query5 = "Select count(*) as AllNum5 from 通知单 where 通知单状态='已完成' and 地区省='$province6' and 地区市='$city6' and 检查日期 between '$liu'and '$endtime'"; 
    				...
    				<div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
			    						...
			    						<thead>
									      ...
									      <?php
						                   require("conn.php");
						                   $sql = "select * from 通知单 where 通知单状态='草稿'  ";
						                   $result = $conn->query($sql);
						                   while($row = $result->fetch_assoc()) {    					
						                   ?>
						                   <tr class="">
						                   ...
						                   <td><a href="ProjectPlus/cgbh.php?id=<?php echo $row["id"];?>&sjc=<?php echo $row["时间戳"];?>"><?php echo $row["通知单编号"];?></a></td>
								...
								<div class="modal-content">
		    						...
		    						<thead>
											 ...
											 <tbody>
										      <?php
							                   require("conn.php");
							                   $sql = "select * from 通知单 where 通知单状态='整改中' ";
							                   $result = $conn->query($sql);
							                   while($row = $result->fetch_assoc()) {    					
							                   ?>
							                   <tr class="">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
								      ...
								      <?php
					                   require("conn.php");
					                   $sql = "select * from 通知单 where 通知单状态='延期' ";
					                   $result = $conn->query($sql);
					                   while($row = $result->fetch_assoc()) {    					
					                   ?>
					                   <tr class="">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
								      ...
								      <?php
					                   require("conn.php");
					                   $sql = "select * from 通知单 where 通知单状态='逾期' ";
					                   $result = $conn->query($sql);
					                   while($row = $result->fetch_assoc()) {    					
					                   ?>
					                   <tr class="">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
								      ...
								      <?php
					                   require("conn.php");
					                   $sql = "select * from 通知单 where 通知单状态='已完成' ";
					                   $result = $conn->query($sql);
					                   while($row = $result->fetch_assoc()) {    					
					                   ?>
					                   <tr class="">
						...
						<div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    						...
    						<thead>
								      ...
								      <?php
					                   require("conn.php");
					                   $sql = "select * from  通知单 where 通知单状态='未完成' ";
					                   $result = $conn->query($sql);
					                   while($row = $result->fetch_assoc()) {    					
					                   ?>
					                   <tr class="">
